...
(4, 1, 1, 3, '綿', 'UNIQLO', 'カジュアル,きれいめ', '夏,春', '半袖,クルーネック', 1, 1, NOW(), NOW(), 0, 'T001 白Tシャツ', ''),
(5, 19, 1, 3, '綿', 'UNIQLO', 'カジュアル,きれいめ', '夏,春', '半袖,Vネック', 1, 1, NOW(), NOW(), 0, 'T002 黒Tシャツ', ''),
(6, 1, 1, 3, '綿', 'UNIQLO', 'きれいめ,カジュアル,フォーマル', '春,秋', '長袖,ボタンダウン,カジュアル', 2, 1, NOW(), NOW(), 0, 'T003 白シャツ', ''),
(7, 19, 1, 3, 'ウール', 'UNIQLO', 'きれいめ,カジュアル', '冬', '長袖,クルーネック,厚手', 5, 1, NOW(), NOW(), 0, 'T004 ネイビーニット', ''),
(8, 17, 1, 3, 'カシミヤ', 'UNIQLO', 'きれいめ,カジュアル', '冬,秋', '長袖,Vネック,薄手', 5, 1, NOW(), NOW(), 0, 'T005 グレーニット', ''),
(9, 17, 1, 3, '綿', 'UNIQLO', 'カジュアル,ストリート', '春,秋', '長袖,フード付き,裏起毛なし', 7, 1, NOW(), NOW(), 0, 'T006 グレーパーカー', ''),
(10, 13, 1, 3, '綿', 'UNIQLO', 'きれいめ,カジュアル', '春,夏,秋,冬', '長袖,ボタンダウン', 2, 1, NOW(), NOW(), 0, 'T007 サックスブルーシャツ', ''),
(11, 19, 1, 3, '綿', 'UNIQLO', 'カジュアル,きれいめ', '春,夏,秋', '半袖,ボタンダウン', 4, 1, NOW(), NOW(), 0, 'T008 ネイビーポロシャツ', ''),
(12, 19, 1, 3, 'デニム', 'UNIQLO', 'カジュアル', '春,夏,秋,冬', 'ロング丈,ストレート', 39, 1, NOW(), NOW(), 0, 'B001 インディゴデニムパンツ', ''),
(13, 19, 1, 3, 'ポリエステル', 'UNIQLO', 'きれいめ,フォーマル', '春,夏,秋,冬', 'ロング丈,テーパード,センタープレス', 43, 1, NOW(), NOW(), 0, 'B002 黒スラックス', ''),
(14, 17, 1, 3, 'ウール', 'UNIQLO', 'きれいめ,フォーマル', '冬,秋', 'ロング丈,ストレート', 43, 1, NOW(), NOW(), 0, 'B003 グレースラックス', ''),
(15, 4, 1, 3, '綿', 'UNIQLO', 'カジュアル', '春,秋,冬', 'ロング丈,ストレート', 41, 1, NOW(), NOW(), 0, 'B004 ベージュチノパンツ', ''),
(16, 19, 1, 3, 'デニム', 'UNIQLO', 'カジュアル,きれいめ', '春,秋,冬', 'ロング丈,スリム', 39, 1, NOW(), NOW(), 0, 'B005 黒デニムパンツ', ''),
(17, 16, 1, 3, '綿', 'UNIQLO', 'カジュアル,ストリート', '春,夏,秋', 'ロング丈,ストレート,ポケット付き', 40, 1, NOW(), NOW(), 0, 'B006 カーキカーゴパンツ', ''),
(18, 19, 1, 3, 'ポリエステル', 'UNIQLO', 'きれいめ,フォーマル', '春,秋', '長袖,シングル', 16, 1, NOW(), NOW(), 0, 'O001 ネイビーテーラードジャケット', ''),
(19, 19, 1, 3, 'ダウン', 'UNIQLO', 'カジュアル,きれいめ', '冬', '長袖,フード付き,ロング丈', 24, 1, NOW(), NOW(), 0, 'O002 黒ダウンコート', ''),
(20, 4, 1, 3, '綿', 'UNIQLO', 'きれいめ,トラッド', '春,秋', '長袖,ロング丈,ベルト付き', 28, 1, NOW(), NOW(), 0, 'O003 ベージュトレンチコート', '');
